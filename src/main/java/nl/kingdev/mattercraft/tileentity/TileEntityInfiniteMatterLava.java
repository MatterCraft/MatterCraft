...
public class TileEntityInfiniteMatterLava extends TileEntityBase implements ITickable {

    private FluidTank tank;

    public TileEntityInfiniteMatterLava() {
    	this.tank = new FluidTank(FluidRegistry.LAVA, 2048000, 2048000);
    	...
    	if(this.worldObj != null) {
    		if(!this.worldObj.isRemote) {
    			if(this.tank.getFluidAmount() != 2048000)
    				this.tank.fillInternal(new FluidStack(FluidRegistry.LAVA, this.tank.getCapacity()), true);
