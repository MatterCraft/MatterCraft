...
public class TileEntityPhotonGenerator extends TileEntityBase implements ITickable {
	...
	private BlockPos matterFabricatorPos;
	...
	public void update() {
		if(this.worldObj != null) {
			if(!this.worldObj.isRemote) {
				if(this.matterFabricatorPos == null || this.worldObj.getBlockState(this.matterFabricatorPos).getBlock() == ModBlocks.matterFabricator) {
